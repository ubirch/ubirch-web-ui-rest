...
object DeviceFactory extends LazyLogging {
  ...
  def getBySecondaryIndex(index: String, namingConvention: String, brief: Boolean = false)(implicit realmName: String): UserRepresentation =
    MemberFactory.getByFirstName(index, namingConvention, brief)
